...
#[derive(Debug)]
pub struct VirtualEarthProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VirtualEarthProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VirtualEarth processing");
    
    let mut processor = VirtualEarthProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VirtualEarthProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VirtualEarthProcessor::new(false);
